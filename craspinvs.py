...
aaa=input('Entre name of the list : ')
os.system('clear')
os.system('printf "\033[3;36m"')
os.system('figlet List - Craspinvs')
print('Created By : Craspinvs ((TUN_))')
print('-'*30)
file=open(aaa,'w')
aa=set([])
oio=set([])
#iio=set([112233,332211,000,445566,'$'*1,'$'*2,'$'*3,'@'*1,'@'*2,'@'*3,'€'*1,'€'*2,'€'*3,'&'*1,'&'*2,'&'*3,'¥'*1,'¥'*2,'¥'*3,'*'*1,'*'*2,'*'*3
kk=1
while True :
